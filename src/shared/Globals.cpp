...
int TIME_STEP = 10;	// Milliseconds, for path planning. Decrease to be faster.
...
int PLAN_TIME_OFFSET = 500;	// Milliseconds
int DROP_TIME = 200;	// Milliseconds, time required to drop arm
int MOTOR_DELAY = 200;	// Account for slight lag in motor response to commands
int ADJUST_FACTOR = 200;	// Use this to adjust if the arm fails to hit moving coins
