Module dynamixel
    ...
    Public Declare Function dxl_initialize Lib "dynamixel.dll" Alias "dxl_initialize" () As Integer
    Public Declare Sub dxl_terminate Lib "dynamixel.dll" Alias "dxl_terminate" ()
    Public Declare Function dxl_get_baud Lib "dynamixel.dll" Alias "dxl_get_baud" () As Integer
    Public Declare Sub dxl_set_baud Lib "dynamixel.dll" Alias "dxl_set_baud" (ByVal baudnum As Integer)
    ...
    Public Declare Sub dxl_set_txpacket_parameter Lib "dynamixel.dll" Alias "dxl_set_txpacket_parameter" (ByVal value As Integer)
    ...
    Public Declare Sub dxl_write_word Lib "dynamixel.dll" Alias "dxl_write_word" (ByVal id As Integer, ByVal address As Integer)
